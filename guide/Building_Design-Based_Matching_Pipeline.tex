...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Rosenbaum (2018) objective: expectation {-} observed + kappa * SD Nonpositive}
\CommentTok{\# values imply rejection at level alpha}
...
\NormalTok{    null\_sd }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{(null\_variance)}
    ...
    \CommentTok{\# obs\_stat), + Normal buffer (kappa * null\_sd)}
