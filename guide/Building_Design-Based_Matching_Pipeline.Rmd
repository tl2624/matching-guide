...
Note, however, that the matched design may alter the study population over which these causal targets are defined relative to the original set of units [@rosenbaumrubin1985]. Units excluded from the matched design --- because they lack suitable matches under the chosen calipers or exact-match constraints --- are no longer part of the study population to which inference applies. Consequently, both $\bm{\tau}$ and $\tau$ refer only to the subpopulation of units retained after matching. This restriction has important implications for interpretation; yet the resulting study population is often difficult to interpret, particularly when matching is based on the estimated propensity score. For this reason, @rosenbaum2010 cautions that "it is usually better to go back to the covariates themselves ... perhaps redefining the population under study to be a subpopulation of the original population" (p. 86), a point echoed in @stuart2010. Several approaches explicitly address the issue of defining and interpreting these study populations in the context of propensity score methods and matching more generally [@rosenbaum2012; @fogartyetal2016; @traskinsmall2011; @crumpetal2009].
